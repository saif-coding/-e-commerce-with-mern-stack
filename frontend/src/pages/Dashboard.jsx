...
function Dashboard() {
  ...
  const sidebarLinks = [
    ...
    { name: "Product List", path: "/dashboard/productlist", icon: chaticon },
    { name: "Add Products ", path: "/dashboard/addproduct", icon: chaticon },
    { name: "Orders List ", path: "/dashboard/orders", icon: chaticon },
  ];
